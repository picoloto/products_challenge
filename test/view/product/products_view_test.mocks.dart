...
// in products_challenge/test/view/product/products_view_test.dart.
...
import 'package:products_challenge/model/product/product_model.dart' as _i9;
...
import 'package:products_challenge/service/product_local/product_local_service.dart'
    as _i2;
import 'package:products_challenge/shared/utils/debouncer.dart' as _i6;
...
class _FakeDebouncer_4 extends _i1.SmartFake implements _i6.Debouncer {
  _FakeDebouncer_4(
    Object parent,
    Invocation parentInvocation,
  ) : super(
...
class _FakeProductsState_5 extends _i1.SmartFake implements _i7.ProductsState {
  _FakeProductsState_5(
    Object parent,
    Invocation parentInvocation,
  ) : super(
          parent,
...
class MockProductsLocalStore extends _i1.Mock
    implements _i8.ProductsLocalStore {
  @override
  ...
  @override
  set products(List<_i9.Product>? _products) => super.noSuchMethod(
        Invocation.setter(
          #products,
          _products,
        ),
  ...
  @override
  _i10.Future<void> addProductFavorite(_i9.Product? product) =>
      (super.noSuchMethod(
        Invocation.method(
          #addProductFavorite,
          [product],
  ...
  @override
  _i10.Future<void> findAllFavorites() => (super.noSuchMethod(
        Invocation.method(
          #findAllFavorites,
          [],
        ),
  ...
  @override
  bool isFavorite(_i9.Product? product) => (super.noSuchMethod(
        Invocation.method(
          #isFavorite,
          [product],
        ),
...
/// A class which mocks [ProductsStore].
///
/// See the documentation for Mockito's code generation for more information.
class MockProductsStore extends _i1.Mock implements _i11.ProductsStore {
  @override
  ...
  @override
  _i6.Debouncer get debouncer => (super.noSuchMethod(
        Invocation.getter(#debouncer),
        returnValue: _FakeDebouncer_4(
          this,
          Invocation.getter(#debouncer),
        ),
        returnValueForMissingStub: _FakeDebouncer_4(
          this,
          Invocation.getter(#debouncer),
        ),
      ) as _i6.Debouncer);
  ...
  @override
  set debouncer(_i6.Debouncer? _debouncer) => super.noSuchMethod(
        Invocation.setter(
          #debouncer,
          _debouncer,
        ),
  ...
  @override
  _i7.ProductsState get state => (super.noSuchMethod(
        Invocation.getter(#state),
        returnValue: _FakeProductsState_5(
          this,
          Invocation.getter(#state),
        ),
        returnValueForMissingStub: _FakeProductsState_5(
          this,
          Invocation.getter(#state),
        ),
      ) as _i7.ProductsState);

  @override
  set state(_i7.ProductsState? value) => super.noSuchMethod(
        Invocation.setter(
          #state,
          value,
        ),
  ...
  @override
  _i10.Future<void> findProducts() => (super.noSuchMethod(
        Invocation.method(
          #findProducts,
          [],
        ),
  ...
  @override
  _i10.Future<void> findProductsByTitle(String? title) => (super.noSuchMethod(
        Invocation.method(
          #findProductsByTitle,
          [title],
        ),
